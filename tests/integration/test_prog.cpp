...
/*void print_choice(void){
        cout<<"Press key 1 to output entered text 10 times to stdout, create
   file and write the text 10 times there"<<endl; cout<<endl; cout<<"Press key 2
   to output two entered text 10 times to console, create file and write the
   text 10 times there"<<endl; cout<<endl; cout<<"Press key 3 to output of
   entered texts to console, create file and write the text there"<<endl;
...
int main(int argc, char* argv[]) {
  ...
  std::stringstream convert(
      argv[1]);  // create varibale stringstream with name convert, initializing
                 // it with the value of argv[1]
  ...
  if (a == 1) {
    cout << "You've chosen to output entered text 10 times to stdout, create "
            "file and write the text 10 times there"
         << endl;
    ...
    cout << "Now output with infinite loop function taking one argument: "
         << endl;
    string str3;
